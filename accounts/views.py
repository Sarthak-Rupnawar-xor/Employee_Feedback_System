...
def admin_dashboard(req):
    ...
    selected_user= req.GET.get('employee')
    all_feedbacks = Feedback.objects.filter(is_deleted=False).select_related('employee').order_by('-submitted_at')
    ...
    return render(req, 'accounts/admin_dashboard.html', context)
